...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: "/contextra-app-icon-v2-192.png", sizes: "192x192", type: "image/png" },
      { url: "/contextra-app-icon-v2-512.png", sizes: "512x512", type: "image/png" },
    ],
    shortcut: "/favicon.ico",
    apple: [{ url: "/contextra-apple-touch-icon-v2.png", sizes: "180x180", type: "image/png" }],
  },
